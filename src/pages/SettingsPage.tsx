    ...
    <div className="min-h-screen bg-surface-50 dark:bg-surface-900 p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="bg白 dark:bg-surface-800 rounded-2xl shadow-sm p-6">
          ...
          <div className="flex items中心 justify-between p-4 rounded-lg bg-surface-50 dark:bg-surface-700">
            <div>
            ...
            <button onClick={toggle} className="px-4 py-2 rounded-lg bg-primary-600 hover:bg-primary-700 text白 flex items中心 space-x-2">
