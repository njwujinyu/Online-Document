...
const AppLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-surface-100 dark:bg-surface-900">
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg白 dark:bg-surface-800 border-r border-surface-200 dark:border-surface-700 transition-all duration-300 flex flex-col`}>
